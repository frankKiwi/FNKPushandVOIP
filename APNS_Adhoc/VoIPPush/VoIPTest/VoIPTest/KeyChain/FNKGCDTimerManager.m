...
@implementation FNKGCDTimerManager

#pragma mark - Public Method

// 单例
+ (FNKGCDTimerManager *)sharedInstance
{
    static FNKGCDTimerManager *_FNKGCDTimerManager = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken,^{
        _FNKGCDTimerManager = [[FNKGCDTimerManager alloc] init];
    });
    
    return _FNKGCDTimerManager;
}
